...
class News_model extends CI_Model
{
    ...
    public function read_pdf($news_id)
    {
        ...
        usort($results, function ($a, $b) {
            return strnatcmp($a->news_pdf_pdf, $b->news_pdf_pdf);
        });
    ...
    public function read_doc($news_id)
    {
        ...
        usort($results, function ($a, $b) {
            return strnatcmp($a->news_file_doc, $b->news_file_doc);
        });
    ...
    public function read_img($news_id)
    {
        ...
        $results = $query->result();
        usort($results, function ($a, $b) {
            return strnatcmp($a->news_img_img, $b->news_img_img);
        });
        return $results;
    }
    ...
    public function del_pdf($pdf_id)
    {
        ...
        $this->log_model->add_log(
            'ลบ',
            'ข่าวประชาสัมพันธ์',
            'ไฟล์ PDF: ' . $file_data->news_pdf_pdf . ' จากข่าว: ' . ($old_data ? $old_data->news_name : 'ไม่ระบุ'),
    ...
    public function del_doc($doc_id)
    {
        ...
        $this->log_model->add_log(
            'ลบ',
            'ข่าวประชาสัมพันธ์',
            'ไฟล์ DOC: ' . $file_data->news_file_doc . ' จากข่าว: ' . ($old_data ? $old_data->news_name : 'ไม่ระบุ'),
    ...
    public function del_img($file_id)
    {
        ...
        $this->log_model->add_log(
            'ลบ',
            'ข่าวประชาสัมพันธ์',
            'รูปภาพ: ' . $file_data->news_img_img . ' จากข่าว: ' . ($old_data ? $old_data->news_name : 'ไม่ระบุ'),
