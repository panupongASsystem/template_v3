...
?>
<?php
// ✅ คำนวณค่า Trial Storage Limit แบบ Dynamic ครั้งเดียว
$trial_limit_text = '5GB'; // Default fallback

if (isset($trial_storage_limit) && $trial_storage_limit > 0) {
    $trial_limit_gb = round($trial_storage_limit / (1024 * 1024 * 1024), 1);
    $trial_limit_text = ($trial_limit_gb == floor($trial_limit_gb))
        ? intval($trial_limit_gb) . 'GB'
        : $trial_limit_gb . 'GB';
} elseif (isset($system_settings['trial_storage_limit']) && $system_settings['trial_storage_limit'] > 0) {
    $trial_limit_gb = round($system_settings['trial_storage_limit'] / (1024 * 1024 * 1024), 1);
    $trial_limit_text = ($trial_limit_gb == floor($trial_limit_gb))
        ? intval($trial_limit_gb) . 'GB'
        : $trial_limit_gb . 'GB';
}
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-orange-700">
                        ขีดจำกัดพื้นที่ <?php echo $trial_limit_text; ?> •
                        ฟีเจอร์บางอย่างถูกจำกัด •
                        อัปเกรดเพื่อใช้งานเต็มรูปแบบ
                    </p>
                </div>
            </div>
            <button onclick="showUpgradeModal()"
                class="px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl hover:from-orange-600 hover:to-orange-700 transition-all duration-300 shadow-lg font-semibold">
...
<main class="max-w-[80%] mx-auto px-2 sm:px-4 lg:px-6 py-8">
    ...
    <div class="glass-card apple-shadow rounded-3xl p-8 mb-8">
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div class="flex items-center space-x-6">
                <div
                    class="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl flex items-center justify-center shadow-lg animate-float">
                    ...
                    <div class="flex items-center mt-2 space-x-4">
                        ...
                        <?php if (isset($is_trial_mode) && $is_trial_mode): ?>
                            <span
                                ...
                                โหมดทดลอง - ขีดจำกัด <?php echo $trial_limit_text; ?>
                            </span>
                        <?php else: ?>
                            <span
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="<?php echo site_url('User/Choice'); ?>"
                    ...
                    <div
                        class="w-10 h-10 bg-gradient-to-br from-blue-100 to-blue-200 group-hover:from-blue-500 group-hover:to-blue-600 rounded-xl flex items-center justify-center mr-3 transition-all duration-300 shadow-sm">
                    ...
                    <div class="text-left">
                        ...
                        <div class="text-xs text-gray-500 group-hover:text-blue-500 transition-colors duration-300">
                            Smart Office</div>
                    </div>
                </a>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <!-- System Total Storage (แทน Personal Quota) -->
        <div class="glass-card apple-shadow rounded-2xl p-6 card-hover">
            <div class="flex items-center">
                <div
                    class="w-14 h-14 bg-gradient-to-br from-green-100 to-green-200 rounded-2xl flex items-center justify-center shadow-lg">
                ...
                <div class="ml-4 flex-1">
                    ...
                    <!-- ✅ เปลี่ยน ID: personalQuotaUsed -> systemStorageUsed -->
                    <p class="text-2xl font-bold text-gray-800 mt-1" id="systemStorageUsed">-</p>

                    <div class="w-full bg-gray-200 rounded-full h-2.5 mt-3">
                        <!-- ✅ เปลี่ยน ID: personalQuotaBar -> systemStorageBar -->
                        <div class="bg-gradient-to-r from-green-400 to-green-500 h-2.5 rounded-full transition-all duration-1000"
                            id="systemStorageBar" style="width: 0%"></div>
                    </div>

                    <!-- ✅ เปลี่ยน ID: quotaDetails -> systemStorageDetails -->
                    <p class="text-xs text-gray-500 mt-1" id="systemStorageDetails">กำลังโหลด...</p>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card apple-shadow rounded-2xl p-6 card-hover">
            <div class="flex items-center">
                <div
                    class="w-14 h-14 bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl flex items-center justify-center shadow-lg">
        ...
        <div class="glass-card apple-shadow rounded-2xl p-6 card-hover">
            <div class="flex items-center">
                <div
                    class="w-14 h-14 bg-gradient-to-br from-purple-100 to-purple-200 rounded-2xl flex items-center justify-center shadow-lg">
        ...
        <div class="glass-card apple-shadow rounded-2xl p-6 card-hover">
            <div class="flex items-center">
                <div
                    class="w-14 h-14 bg-gradient-to-br from-orange-100 to-orange-200 rounded-2xl flex items-center justify-center shadow-lg">
    ...
    <div class="glass-card apple-shadow rounded-2xl p-6 mb-6">
        <div class="flex items-center space-x-3">
            <div
                class="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl shadow-sm">
            ...
            <div class="flex-1">
                ...
                <nav class="flex items-center space-x-2 text-sm" id="breadcrumb">
                    <div
                        class="flex items-center space-x-2 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl px-4 py-2">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <button onclick="navigateBack()"
                        ...
                        id="backBtn" title="ย้อนกลับโฟลเดอร์ก่อนหน้า">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <div class="flex items-center bg-white/50 rounded-xl p-1 border border-gray-200/50">
                    <button id="treeViewBtn" onclick="changeViewMode('tree')"
                        class="view-mode-btn active p-2.5 rounded-lg transition-all duration-200" title="มุมมองแผนผัง">
                        <i class="fas fa-sitemap text-sm"></i>
                    </button>
                    <button id="gridViewBtn" onclick="changeViewMode('grid')"
                        class="view-mode-btn p-2.5 rounded-lg transition-all duration-200" title="มุมมองตาราง">
                        <i class="fas fa-th text-sm"></i>
                    </button>
                    <button id="listViewBtn" onclick="changeViewMode('list')"
                        class="view-mode-btn p-2.5 rounded-lg transition-all duration-200" title="มุมมองรายการ">
                ...
                <div class="flex items-center bg-white/50 rounded-xl p-1 border border-gray-200/50">
                    <button id="sortNameBtn" onclick="sortFiles('name')"
                        class="sort-btn active p-2.5 rounded-lg transition-all duration-200" title="เรียงตามชื่อ">
                        <i class="fas fa-sort-alpha-down text-sm"></i>
                    </button>
                    <button id="sortDateBtn" onclick="sortFiles('modified')"
                        class="sort-btn p-2.5 rounded-lg transition-all duration-200" title="เรียงตามวันที่แก้ไข">
                        <i class="fas fa-sort-numeric-down text-sm"></i>
                    </button>
                    <button id="sortSizeBtn" onclick="sortFiles('size')"
                        class="sort-btn p-2.5 rounded-lg transition-all duration-200" title="เรียงตามขนาด">
                        <i class="fas fa-sort-amount-down text-sm"></i>
                    </button>
                    <button id="sortTypeBtn" onclick="sortFiles('type')"
                        class="sort-btn p-2.5 rounded-lg transition-all duration-200" title="เรียงตามประเภท">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="searchInput" placeholder="ค้นหาไฟล์..." onkeyup="searchFiles(this.value)"
    ...
    <div class="glass-card apple-shadow rounded-2xl overflow-hidden min-h-96 relative" id="fileBrowserContainer">
        ...
        <div id="folderTreeSidebar"
            class="hidden absolute left-0 top-0 w-80 h-full bg-white/90 backdrop-blur-20 border-r border-gray-200/50 z-10">
            <div class="p-6">
        ...
        <div id="dropZoneOverlay"
            class="hidden absolute inset-0 z-50 bg-gradient-to-br from-blue-500/20 to-purple-500/20 border-4 border-dashed border-blue-500 rounded-2xl flex items-center justify-center apple-blur">
            <div class="text-center animate-bounce">
                <div
                    class="w-32 h-32 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mb-8 mx-auto shadow-2xl">
        ...
        <div id="loadingState" class="flex items-center justify-center py-32">
            <div class="text-center">
                <div
                    class="w-20 h-20 border-4 border-blue-200 border-t-blue-600 rounded-full animate-spin mb-8 mx-auto">
                </div>
        ...
        <div id="emptyState" class="hidden flex items-center justify-center py-32">
            <div class="text-center max-w-lg mx-auto">
                <div
                    class="w-32 h-32 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center mb-8 mx-auto shadow-lg">
                ...
                <?php if (isset($is_trial_mode) && $is_trial_mode): ?>
                    <p class="text-orange-600 mb-4 text-sm font-medium">โหมดทดลอง - สามารถอัปโหลดได้สูงสุด 5GB</p>
                <?php endif; ?>
        ...
        <div id="errorState" class="hidden flex items-center justify-center py-32">
            <div class="text-center max-w-lg mx-auto">
                <div
                    class="w-32 h-32 bg-gradient-to-br from-red-100 to-red-200 rounded-full flex items-center justify-center mb-8 mx-auto shadow-lg">
        ...
        <div class="glass-card apple-shadow rounded-2xl p-8">
            ...
            <div class=" pt-6">
                ...
                <div class="flex items-center justify-center mt-6 space-x-6">
                    <a href="<?php echo site_url('google_drive_legal/privacy'); ?>"
                        class="text-gray-400 hover:text-black transition-colors">
                        <i class="fas fa-shield-alt mr-2"></i>นโยบายความเป็นส่วนตัว
                    </a>
                    <a href="<?php echo site_url('google_drive_legal/terms'); ?>"
                        class="text-gray-400 hover:text-black transition-colors">
            ...
            <!-- Trial Mode Warning -->
            <?php if (isset($is_trial_mode) && $is_trial_mode): ?>
                <!-- ✅ ลบส่วนคำนวณค่าออก ใช้ตัวแปร $trial_limit_text ที่คำนวณไว้แล้ว -->
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-orange-700">
                                    <div class="flex items-center">
                                        ...
                                        <span>ขีดจำกัดพื้นที่ <?php echo $trial_limit_text; ?></span>
                                    </div>
                                    <div class="flex items-center">
                ...
                <div class="flex items-center justify-between text-sm text-gray-500">
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="flex items-center">
                            ...
                            <span>โหมด:
                                <?php echo isset($storage_mode) ? ($storage_mode === 'centralized' ? 'Centralized' : 'User-based') : 'Unknown'; ?></span>
                        </div>
                        <div class="flex items-center">
                ...
                <div class="share-type-card bg-white rounded-xl p-4 border border-gray-200" id="sharePeopleCard">
                    ...
                    <div class="mt-4 pt-3 border-t border-gray-100 space-y-3">
                        ...
                        <div class="flex space-x-2">
                            <button onclick="setEmailPermission('reader')"
                                class="email-permission-btn active flex-1 px-3 py-2 bg-purple-500 text-white rounded-lg text-sm font-medium"
                                data-permission="reader">
                                <i class="fas fa-eye mr-1"></i>ดูได้
                            </button>
                            <button onclick="setEmailPermission('writer')"
                                class="email-permission-btn flex-1 px-3 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium"
                        ...
                        <button onclick="shareWithEmail()" id="shareEmailBtn"
                            class="w-full px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 font-medium text-sm transition-colors">
        ...
        <div class="glass-card apple-shadow-lg rounded-3xl p-8 w-full max-w-4xl mx-4 transform transition-all duration-300">
            <div class="flex justify-between items-center mb-8">
                <h3 class="text-3xl font-bold text-gray-800 flex items-center">
                    <div
                        class="w-10 h-10 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center mr-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <!-- 100GB Plan -->
                <div
                    class="bg-white rounded-2xl p-6 border border-gray-200 hover:border-blue-300 transition-all duration-300 transform hover:-translate-y-1">
                    <div class="text-center">
                        <h4 class="text-xl font-bold text-gray-800 mb-2">100 GB</h4>
                        <p class="text-2xl font-bold text-green-600 mb-6">฿2,000<span
                                class="text-lg font-normal text-gray-600">/ปี</span></p>
                        ...
                        <button onclick="selectPlan('100GB')"
                            class="w-full px-6 py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl hover:from-purple-600 hover:to-purple-700 transition-all duration-300 font-semibold">
                            ฿2,000 / ปี
                        </button>
                    </div>
                </div>
                ...
                <div
                    class="bg-white rounded-2xl p-6 border-2 border-blue-500 relative hover:border-blue-600 transition-all duration-300 transform hover:-translate-y-1 shadow-lg">
                    <div class="absolute -top-3 left-1/2 transform -translate-x-1/2">
                        <span
                            class="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-1 rounded-full text-sm font-semibold">แนะนำ</span>
                    </div>
                    <div class="text-center">
                        <h4 class="text-xl font-bold text-gray-800 mb-2">200 GB</h4>


                        <p class="text-2xl font-bold text-green-600 mb-6">฿3,500<span
                                class="text-lg font-normal text-gray-600">/ปี</span></p>
                        ...
                        <button onclick="selectPlan('200GB')"
                            class="w-full px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 font-semibold shadow-lg">
                            ฿3,500 / ปี
                        </button>
                    </div>
                </div>
                ...
                <!-- 2TB Plan -->
                <div
                    class="bg-white rounded-2xl p-6 border border-gray-200 hover:border-purple-300 transition-all duration-300 transform hover:-translate-y-1">
                    <div class="text-center">
                        <h4 class="text-xl font-bold text-gray-800 mb-2">2 TB</h4>


                        <p class="text-2xl font-bold text-green-600 mb-6">฿7,500<span
                                class="text-lg font-normal text-gray-600">/ปี</span></p>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 mb-6">
                <h4 class="text-lg font-bold text-gray-800 mb-4 flex items-center">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/0/09/Google_One_logo.svg" alt="Google One"
                        class="w-6 h-6 mr-3">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <button onclick="closeUpgradeModal()"
                    class="px-8 py-3 text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-xl font-semibold transition-colors">
                    ใช้ Trial ต่อ
                </button>
                <button onclick="contactAdmin()"
                    class="px-8 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl hover:from-green-600 hover:to-green-700 transition-all duration-300 font-semibold shadow-lg">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-orange-700">
                            ขีดจำกัดพื้นที่ <?php echo $trial_limit_text; ?> • ไฟล์จะถูกจัดเก็บในระบบทดลอง
                        </p>
                    </div>
                </div>
            </div>
...
<div id="createFolderModal"
    class="hidden fixed inset-0 bg-black/50 apple-blur flex items-center justify-center z-50 p-4">
