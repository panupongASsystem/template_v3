    ...
    <div class="container-pages-detail">
        ...
        <div class="pages-content break-word mt-2">
            ...
            if (!empty($rsDoc)) { ?>
                ...
                ?>
                    <div class="doc-preview-container">
                        <div class="doc-header-wrapper">
                            <div class="doc-file-info">
                                ...
                                <div class="doc-file-details">
                                    <a class="doc-title-link" href="<?= base_url('docs/file/' . $doc->p_reb_file_doc); ?>" target="_blank"><?= $doc->p_reb_file_doc; ?></a>
                                    <div class="doc-download-stats">
                                        <span class="doc-download-count">ดาวน์โหลดแล้ว <?= isset($doc->p_reb_file_download) ? $doc->p_reb_file_download : 0; ?> ครั้ง</span>
                                    </div>
                                </div>
                            </div>
                            <a onclick="downloadDocFile(event, <?= $doc->p_reb_file_id; ?>)" href="<?= base_url('docs/file/' . $doc->p_reb_file_doc); ?>" download class="doc-download-button">ดาวน์โหลด</a>
                        </div>
                        ...
                        if (in_array($fileExtension, $officeExtensions)) {
                            ...
                            $fileUrl = base_url('docs/file/' . $doc->p_reb_file_doc);
                        ...
                        ?>
                            <div class="doc-preview-card">
                                <div class="doc-preview-header">
                                    <strong class="doc-preview-title">พรีวิว <?= $fileTypeHeading; ?>: <?= $doc->p_reb_file_doc; ?></strong>
                                </div>
                ...
                <script>
                    function downloadDocFile(event, p_reb_file_id) {
                        // ทำการส่งคำร้องขอ AJAX ไปยัง URL ที่บันทึกการดาวน์โหลดพร้อมกับ ID
                        var xhr = new XMLHttpRequest();
                        xhr.open('GET', '<?= base_url('Pages/increment_download_doc/'); ?>' + p_reb_file_id, true);
                        xhr.send();
