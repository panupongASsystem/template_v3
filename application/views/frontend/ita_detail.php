...
<div class="bg-pages ">
    <div class="container-pages-detail">
        ...
        <div class="pages-content break-word mt-2">
            ...
            <br>
            <?php
            $linkFields = ['ita_link', 'ita_link2', 'ita_link3', 'ita_link4', 'ita_link5'];
            $hasLinks = false;

            foreach ($linkFields as $field) {
                if (!empty($rsData->$field)) {
                    $hasLinks = true;
                    echo '<span class="font-pages-content-detail">ลิงค์เพิ่มเติม:</span> <a class="font-26" href="' . $rsData->$field . '" target="_blank">' . $rsData->$field . '</a><br>';
                }
            }
            ?>
            <br>
            <?php if (!empty($rsDoc)) { ?>
                ...
                <?php foreach ($rsDoc as $doc) {
                    // ดึงข้อมูลของไฟล์
                    $fileInfo = pathinfo($doc->ita_file_doc);
