<div class="text-center pages-head">
    <span class="font-pages-head">ติดตามสถานะเบี้ยยังชีพ</span>
</div>
</div>
...
<?php
// ===================================================================
// follow_elderly_aw_ods.php - หน้าติดตามสถานะเบี้ยยังชีพสำหรับ Guest
// ===================================================================
...
$elderly_aw_ods_info = isset($elderly_aw_ods_info) ? $elderly_aw_ods_info : null;
...
<style>
    /* ===== FOLLOW ELDERLY AW ODS PAGE STYLES ===== */
    .follow-elderly-page {
        --primary-color: #7db3e8;
        --primary-light: #a5c9ea;
    ...
    .info-value.highlight {
        background: linear-gradient(135deg, var(--secondary-color), #e3f2fd);
...
<div class="follow-elderly-page">
    <div class="follow-container">
        ...
        <div class="follow-hero">
            ...
            <h1>ติดตามสถานะเบี้ยยังชีพ</h1>
            <p class="subtitle">ตรวจสอบสถานะการยื่นเรื่องเบี้ยยังชีพผู้สูงอายุ / ผู้พิการ</p>
        </div>
        ...
        <div class="search-section">
            ...
            <form class="search-form" id="searchForm" method="GET" action="<?= current_url() ?>">
                <div class="search-input-group">
                    ...
                    <input type="text" class="search-input" name="ref" id="searchInput"
                        placeholder="กรอกหมายเลขอ้างอิง เช่น E6712345" value="<?= htmlspecialchars($ref_id) ?>"
                        required>
                </div>
            ...
            <div class="search-help">
                ...
                <ul class="search-help-list">
                    ...
                    <li class="search-help-item">
                        <i class="fas fa-check search-help-icon"></i>
                        หมายเลขอ้างอิงขึ้นต้นด้วย "E" ตามด้วยตัวเลข
                    </li>
                    <li class="search-help-item">
                        <i class="fas fa-check search-help-icon"></i>
                        ตัวอย่าง: E6712345, E6800001
                    </li>
                    <li class="search-help-item">
                ...
                <?php if ($elderly_aw_ods_info): ?>
                    ...
                    <div class="result-card">
                        <div class="result-header">
                            ...
                            <div class="result-id">#<?= htmlspecialchars($elderly_aw_ods_info['elderly_aw_ods_id']) ?></div>
                        </div>
                        ...
                        <div class="result-body">
                            ...
                            <div class="info-grid">
                                <div class="info-item">
                                    ...
                                    <div class="info-value highlight">
                                        #<?= htmlspecialchars($elderly_aw_ods_info['elderly_aw_ods_id']) ?>
                                    </div>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">ประเภทเบี้ยยังชีพ</span>
                                    <div class="info-value">
                                        <?= get_elderly_aw_ods_type_display($elderly_aw_ods_info['elderly_aw_ods_type'] ?? 'elderly') ?>
                                    </div>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">ชื่อผู้ยื่นเรื่อง</span>
                                    <div class="info-value">
                                        <?= htmlspecialchars($elderly_aw_ods_info['elderly_aw_ods_by']) ?>
                                    </div>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">เบอร์โทรศัพท์</span>
                                    <div class="info-value">
                                        <?= htmlspecialchars($elderly_aw_ods_info['elderly_aw_ods_phone']) ?>
                                    </div>
                                </div>
                                <div class="info-item">
                                    ...
                                    <div class="info-value">
                                        <?php
                                        if (!empty($elderly_aw_ods_info['elderly_aw_ods_datesave'])) {
                                            $thai_months = [
                                                '01' => 'มกราคม',
                                                '02' => 'กุมภาพันธ์',
                                                '03' => 'มีนาคม',
                                            ...
                                            $date = date('j', strtotime($elderly_aw_ods_info['elderly_aw_ods_datesave']));
                                            $month = $thai_months[date('m', strtotime($elderly_aw_ods_info['elderly_aw_ods_datesave']))];
                                            $year = date('Y', strtotime($elderly_aw_ods_info['elderly_aw_ods_datesave'])) + 543;
                                            $time = date('H:i', strtotime($elderly_aw_ods_info['elderly_aw_ods_datesave']));
                                ...
                                <?php if (!empty($elderly_aw_ods_info['elderly_aw_ods_updated_at'])): ?>
                                    <div class="info-item">
                                        <span class="info-label">อัปเดตล่าสุด</span>
                                        <div class="info-value">
                                            <?php
                                            $date = date('j', strtotime($elderly_aw_ods_info['elderly_aw_ods_updated_at']));
                                            $month = $thai_months[date('m', strtotime($elderly_aw_ods_info['elderly_aw_ods_updated_at']))];
                                            $year = date('Y', strtotime($elderly_aw_ods_info['elderly_aw_ods_updated_at'])) + 543;
                                            $time = date('H:i', strtotime($elderly_aw_ods_info['elderly_aw_ods_updated_at']));
                            ...
                            <div class="status-section">
                                <div class="status-header">
                                    ...
                                    <div
                                        class="status-badge <?= get_elderly_aw_ods_status_class($elderly_aw_ods_info['elderly_aw_ods_status']) ?>">
                                        <?= get_elderly_aw_ods_status_display($elderly_aw_ods_info['elderly_aw_ods_status']) ?>
                                    </div>
                                </div>
                                ...
                                <div class="status-description">
                                    ...
                                    echo $status_descriptions[$elderly_aw_ods_info['elderly_aw_ods_status']] ?? 'สถานะไม่ทราบ';
                                    ?>
                                </div>
                            </div>
                            ...
                            <div class="progress-timeline">
                                ...
                                <div class="timeline-container">
                                    ...
                                    <?php
                                    $current_status = $elderly_aw_ods_info['elderly_aw_ods_status'];
                                    $timeline_steps = [
                                        'submitted' => [
                                        ...
                                        <div class="timeline-item <?= $item_class ?>">
                                            <div class="timeline-content">
                                                ...
                                                <div class="timeline-date">
                                                    <?php if ($step_index <= $current_index && !empty($elderly_aw_ods_info['elderly_aw_ods_datesave'])): ?>
                                                        <?php
                                                        // ใช้วันที่ยื่นเรื่องสำหรับ submitted, ส่วนอื่นใช้วันที่อัปเดต
                                                        $display_date = ($step_status === 'submitted')
                                                            ? $elderly_aw_ods_info['elderly_aw_ods_datesave']
                                                            : ($elderly_aw_ods_info['elderly_aw_ods_updated_at'] ?? $elderly_aw_ods_info['elderly_aw_ods_datesave']);
                            ...
                            <div class="status-section" style="margin-top: 2rem;">
                                ...
                                <div class="info-grid" style="margin-top: 1rem; margin-bottom: 0;">
                                    <div class="info-item">
                                        <span class="info-label">เบอร์โทรศัพท์</span>
                                        <div class="info-value">
                                            <a href="tel:<?= htmlspecialchars($elderly_aw_ods_info['elderly_aw_ods_phone']) ?>"
                                                style="color: var(--primary-color); text-decoration: none;">
                                                <?= htmlspecialchars($elderly_aw_ods_info['elderly_aw_ods_phone']) ?>
                                            </a>
                                        </div>
                                    </div>
                                    <?php if (!empty($elderly_aw_ods_info['elderly_aw_ods_email'])): ?>
                                        <div class="info-item">
                                            <span class="info-label">อีเมล</span>
                                            <div class="info-value">
                                                <a href="mailto:<?= htmlspecialchars($elderly_aw_ods_info['elderly_aw_ods_email']) ?>"
                                                    style="color: var(--primary-color); text-decoration: none;">
                                                    <?= htmlspecialchars($elderly_aw_ods_info['elderly_aw_ods_email']) ?>
                                                </a>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                    ...
                    <div class="no-result">
                        ...
                        <div class="no-result-suggestions">
                            ...
                            <ul class="suggestions-list">
                                ...
                                <li class="suggestions-item">หมายเลขขึ้นต้นด้วย "E" ตามด้วยตัวเลข</li>
...
<script>
    ...
    // *** เพิ่ม: reCAPTCHA Configuration ***
    console.log('🔑 Initial reCAPTCHA check for Follow Elderly AW ODS:');
    ...
    function handleFormSubmit() {
        ...
        form.addEventListener('submit', function (e) {
            ...
            console.log('📝 Follow Elderly AW ODS search submitted - Ref:', searchValue);
            ...
            if (shouldUseRecaptcha) {
                ...
                grecaptcha.ready(function () {
                    console.log('🔧 grecaptcha.ready() called for follow elderly aw ods');

                    grecaptcha.execute(window.RECAPTCHA_SITE_KEY, {
                        action: 'follow_elderly_aw_ods_search'
                    }).then(function (token) {
                        console.log('✅ reCAPTCHA token received for follow elderly aw ods:', token.substring(0, 50) + '...');
                        console.log('📏 Token length:', token.length);

                        performElderlySearchWithRecaptcha(searchValue, token, searchBtn, originalContent);
                    }).catch(function (error) {
                        console.error('❌ reCAPTCHA execution failed for follow elderly aw ods:', error);
                        console.log('🔄 Falling back to search without reCAPTCHA');
                        performElderlySearchWithoutRecaptcha(searchValue, searchBtn, originalContent);
                    });
                });
            } else {
    ...
    function performElderlySearchWithRecaptcha(searchValue, recaptchaToken, searchBtn, originalContent) {
        console.log('📤 Submitting follow elderly aw ods search with reCAPTCHA token...');

        try {
            // เปลี่ยนจาก GET redirect เป็น POST form submission
            ...
            const fields = {
                ...
                'recaptcha_action': 'follow_elderly_aw_ods_search',
                'recaptcha_source': 'follow_elderly_aw_ods_form',
            ...
            console.error('Follow elderly aw ods search with reCAPTCHA error:', error);
            handleElderlySearchError(error);
            restoreElderlySearchButton(searchBtn, originalContent);
        }
    }

    // *** เพิ่ม: Search Function แบบปกติ ***
    function performElderlySearchWithoutRecaptcha(searchValue, searchBtn, originalContent) {
        console.log('📤 Submitting follow elderly aw ods search without reCAPTCHA...');
        ...
        try {
            ...
            console.error('Follow elderly aw ods search without reCAPTCHA error:', error);
            handleElderlySearchError(error);
            restoreElderlySearchButton(searchBtn, originalContent);
        }
    }
    ...
    // *** เพิ่ม: จัดการ Error ***
    function handleElderlySearchError(error) {
        console.error('Follow elderly aw ods search error:', error);
        Swal.fire({
    ...
    function restoreElderlySearchButton(searchBtn, originalContent) {
        if (searchBtn) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        console.log('🚀 Follow Elderly AW ODS Page loading...');
        ...
        try {
            ...
            if (window.RECAPTCHA_SITE_KEY && !window.recaptchaReady) {
                console.log('⏳ Waiting for reCAPTCHA to load for follow elderly aw ods...');

                let checkInterval = setInterval(function () {
                    if (window.recaptchaReady) {
                        console.log('✅ reCAPTCHA is now ready for follow elderly aw ods');
                ...
                setTimeout(function () {
                    if (!window.recaptchaReady) {
                        console.log('⚠️ reCAPTCHA timeout after 10 seconds for follow elderly aw ods');
                        clearInterval(checkInterval);
                    }
                }, 10000);
            }
            ...
            console.log('✅ Follow Elderly AW ODS Page initialized successfully');

            if (FollowConfig.debug) {
                console.log('🔧 Debug mode enabled');
                console.log('⚙️ Configuration:', FollowConfig);
            }
    ...
    console.log("🔍 Follow Elderly AW ODS System loaded successfully");
