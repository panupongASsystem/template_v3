<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('p_sopopip_backend/edit/' . $rsedit->p_sopopip_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateForm()">
                <br>
