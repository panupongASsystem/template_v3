<div class="container">
    <div class="row">
        ...
        echo $canon;
        ?>งบประมาณ</h4>
            <form action=" <?php echo site_url('canon_bgps_backend/edit/' . $rsedit->canon_bgps_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateForm()">
                <br>
