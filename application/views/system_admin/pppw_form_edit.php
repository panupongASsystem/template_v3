<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('pppw_backend/edit/' . $rsedit->pppw_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateForm()">
                <br>
