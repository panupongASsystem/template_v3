<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>เพิ่มข้อมูลรายการผลจัดซื้อจัดจ้าง / จัดหาพัสดุประจำปี</h4>
            <form action=" <?php echo site_url('p_rpobuy_backend/add'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateForm()">
                <br>
