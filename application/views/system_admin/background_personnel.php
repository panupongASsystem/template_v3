            ...
            <table id="newdataTables" class="table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 17%;">ตำแหน่ง</th>
                        <th style="width: 8%;">อัพโหลด</th>
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <?php if (!empty($rs->background_personnel_img1)): ?>
                                        <div class="img-container">
                                            <img src="<?= base_url('docs/img/' . $rs->background_personnel_img1); ?>" width="120px" height="80px">
                                            <small class="d-block text-center">รูปที่ 1</small>
                                        </div>
                                    <?php endif; ?>
                                    <?php if (!empty($rs->background_personnel_img2)): ?>
                                        <div class="img-container">
                                            <img src="<?= base_url('docs/img/' . $rs->background_personnel_img2); ?>" width="120px" height="80px">
                                            <small class="d-block text-center">รูปที่ 2</small>
                                        </div>
                                    <?php endif; ?>
                                    <?php if (!empty($rs->background_personnel_img3)): ?>
                                        <div class="img-container">
                                            <img src="<?= base_url('docs/img/' . $rs->background_personnel_img3); ?>" width="120px" height="80px">
                                            <small class="d-block text-center">รูปที่ 3</small>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </td>
