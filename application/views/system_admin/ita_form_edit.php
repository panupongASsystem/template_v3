<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('ita_backend/edit/' . $rsedit->ita_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateForm()">
                <br>
