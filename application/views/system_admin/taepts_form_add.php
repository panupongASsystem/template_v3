<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>เพิ่มข้อมูลมาตรฐานการส่งเสริมคุณธรรมและความโปร่งใส</h4>
            <form action="<?php echo site_url('taepts_backend/add'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateForm()">
                <br>
                    ...
                    <div class="col-sm-5">
                        <select class="form-control" name="taepts_ref_id" required>
                            ...
                            <?php foreach ($rs_type as $rs) { ?>
                                <option value="<?php echo $rs->taepts_type_id; ?>"><?php echo $rs->taepts_type_name; ?></option>
                                <?php } ?>]
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="taepts_name" id="taepts_name" class="form-control" required>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea name="taepts_detail" id="taepts_detail"></textarea>
                        <script>
                            ClassicEditor
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="datetime-local" name="taepts_date" id="taepts_date" class="form-control" required>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="file" name="taepts_pdf_pdf[]" class="form-control" accept="application/pdf" multiple>
                        <span class="black-add">สามารถอัพโหลดได้หลายไฟล์</span>
                        <br>
