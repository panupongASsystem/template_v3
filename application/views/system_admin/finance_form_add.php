<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>เพิ่มข้อมูลงานการเงินและการบัญชี</h4>
            <form action="<?php echo site_url('finance_backend/add'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateForm()">
                <br>
                    ...
                    <div class="col-sm-5">
                        <select class="form-control" name="finance_ref_id" required>
                            ...
                            <?php foreach ($rs_type as $rs) { ?>
                                <option value="<?php echo $rs->finance_type_id; ?>"><?php echo $rs->finance_type_name; ?></option>
                                <?php } ?>]
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea name="finance_detail" id="finance_detail"></textarea>
                        <script>
                            ClassicEditor
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="datetime-local" name="finance_date" id="finance_date" class="form-control" required>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="file" name="finance_pdf_pdf[]" class="form-control" accept="application/pdf" multiple>
                        <span class="black-add">สามารถอัพโหลดได้หลายไฟล์</span>
                        <br>
