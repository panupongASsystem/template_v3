<div class="container">
    <div class="row">
        ...
        echo $canon;
        ?>การติดตั้งระบบบำบัดน้ำเสียในอาคาร</h4>
            <form action=" <?php echo site_url('canon_ritw_backend/edit/' . $rsedit->canon_ritw_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateForm()">
                <br>
