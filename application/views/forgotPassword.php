...
<body>
    <main>
        <div class="bg">
            <?php for ($i = 1; $i <= 7; $i++) : ?>
                <img class="wipwap" src="<?php echo base_url('docs/animation-star-1.png'); ?>">
            <?php endfor; ?>
            <?php for ($i = 1; $i <= 8; $i++) : ?>
                <img class="wipwap" src="<?php echo base_url('docs/animation-star-2.png'); ?>">
            <?php endfor; ?>
            <div class="bg-content">
                ...
                <form id="reCAPTCHA3" action="<?php echo site_url('user/sendEmail'); ?>" method="post">
                    ...
                    <div class="bg-submit-login">
                        <button data-action="submit" data-callback="onSubmit" data-sitekey="<?php echo get_config_value('recaptcha'); ?>" type="submit" class="loginBtn g-recaptcha" id="loginBtn">ส่ง</button>
