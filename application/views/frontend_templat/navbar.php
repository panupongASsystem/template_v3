  <!-- // ปุ่ม scroll-to-top  -->
  <!-- <a onclick="scrolltotopFunction()" id="scroll-to-top-other" title="เลื่อนขึ้นด้านบน"></a>-->
  ...
  <style>
      ...
      .nav-background .menu-item-7::before {
          background-image: url('<?php echo base_url("docs/bt-header-7-hover.png"); ?>');
      }
      ...
      .nav-background .menu-item-8::before {
          background-image: url('<?php echo base_url("docs/bt-header-8-hover.png"); ?>');
      }
      ...
      .nav-background .menu-item-9::before {
          background-image: url('<?php echo base_url("docs/bt-header-9-hover.png"); ?>');
      }
...
foreach ($all_structure_items as $index => $item) {
    ...
    // 3. ยังมีคอลัมน์เหลือ
    if ($items_in_current_column >= $items_per_column && 
        !$is_sub_item && 
...
<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="d-flex justify-content-center">
      <div class="text-center" style="z-index: 5; position: absolute; margin-top: 35px; ">
          <img class="logo-animate" style=" width: 153px; height: 153px;" src="<?php echo base_url('docs/logo-nav.png'); ?>">
      </div>
  </div>
...
?>
          ...
          <div class="nav-background" style="margin-left: 1010px;">
