<div class="container">
    <dov class="row">
        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('emp/editpwd'); ?> " method="post" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input type="password" name="m_password" class="form-control" required minlength="3">
                    </div>
                </div>
                <br>
                <div class="form-group row">
